...
if (! function_exists('view')) {
    ...
    function error($info,$data=null)
    {
      return  httpCallback(400,$info,$data);
    }
    function permissionDenied($info)
    {
      return  httpCallback(401,$info);
    }

    function success($info='请求',$data=null)
    {
      return  httpCallback(200,$info.'成功',$data);
    }

    function httpCallback($code,$info,$data=null)
    {
        $res = [
            'code'=>$code,
            'msg'=>$info,
    ...
    function callbackByBool($bool,$operation,$data=null){
        if($bool===false){
            return error($operation.'失败,请稍后再试');
        }
